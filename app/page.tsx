...
import { categoryShowcase, mockProducts } from "@/lib/data/mock-products";
  ...
  return (
    <div className="container-edge py-2" aria-hidden>
      <div className="flex items-center justify-center gap-3 text-gold/80">
        <span className="h-px w-14 bg-gold/45 sm:w-24" />
...
export default function HomePage() {
  ...
  const trending = mockProducts.filter((p) => p.isFeatured).slice(0, 4);
  ...
  return (
    <>
      <section className="relative h-[88vh] min-h-[560px] w-full overflow-hidden bg-ink">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-ink/35 via-ink/30 to-ink/60" />
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <span className="eyebrow text-gold animate-fade-up">Where Heritage Becomes Jewellery</span>
          <h1 className="mt-4 max-w-3xl font-display text-display text-ivory animate-fade-up-delay-1">
            Carved in Stone.<br />Cast in Gold.
          </h1>
          <p className="mt-5 max-w-xl text-body-lg text-ivory/85 animate-fade-up-delay-2">
            Fine jewellery inspired by the Sun Temple of Konark — hallmarked gold, certified
            stones, hand-finished detail.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4 animate-fade-up-delay-3">
      ...
      <section className="border-y border-border/70 bg-ivory py-4">
        <div className="container-edge grid grid-cols-2 gap-y-3 text-center text-caption uppercase tracking-widest text-text-muted sm:grid-cols-4">
          <p>BIS Hallmarked Gold</p>
          <p>Certified Gemstones</p>
          <p>Insured Pan-India Shipping</p>
        ...
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {categoryShowcase.map((c) => (
            <Link
              key={c.slug}
              href={`/shop/${c.slug}`}
              className="group relative block aspect-[3/4] overflow-hidden border border-border/70 shadow-card transition-all duration-500 ease-premium hover:-translate-y-1 hover:border-gold/50 hover:shadow-card-hover"
            >
              <Image
                src={c.image}
                alt={c.name}
        ...
        <div className="container-edge">
          <div className="mb-10 flex items-end justify-between">
            ...
            <Link
              ...
              className="hidden text-body-sm underline underline-offset-4 sm:inline"
            >
              View all
            </Link>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container-edge">
          <div className="mb-10 flex items-end justify-between">
            <div>
              <span className="eyebrow">Style Momentum</span>
              <h2 className="mt-2 font-display text-h2">Trending Now</h2>
            </div>
            <Link href="/shop" className="hidden text-body-sm underline underline-offset-4 sm:inline">
              Explore all
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 lg:grid-cols-4">
      ...
      <section className="container-edge grid grid-cols-1 gap-10 py-16 lg:grid-cols-2 lg:items-center lg:py-24">
        <div className="relative aspect-[4/5] overflow-hidden border border-border/70 shadow-card">
          <Image
        ...
        <div className="max-w-lg">
          ...
          <p className="mt-5 text-body-lg text-text-muted">
            ...
            wheels and radiating stone into wearable gold. Each piece passes through the hands of a
            single master artisan from wax model to final polish — nothing is cast at volume.
          </p>
      ...
      <RecentlyViewedRail products={mockProducts} />
      ...
      <section className="py-16 lg:py-24">
        <div className="container-edge max-w-xl text-center">
          ...
          <p className="mt-3 text-body text-text-muted">
            New arrivals, heritage stories, and early access to limited pieces — straight to your
            inbox.
          </p>
          <form className="mx-auto mt-6 flex max-w-md border border-ink/20">
